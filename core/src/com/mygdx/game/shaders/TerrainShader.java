...
public class TerrainShader extends BaseShader {
    ...
    public void init() {
        ...
        u_ambientLight = program.fetchUniformLocation("u_ambientLight", false);// from pbrdhader
    }
    ...
    public static String getDefaultVertexShader()  {
        return Gdx.files.internal("shaders/terrainVertex.glsl").readString();
    }

    public static String getDefaultFragmentShader()  {
        return Gdx.files.internal("shaders/terrainfragment.glsl").readString();
    }
